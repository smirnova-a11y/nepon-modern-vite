const BUILTIN = [
  ...
  },
  {
    ...
    function openForm(cat=null) { state.editingId=cat?cat.id:null; $('#formTitle').textContent=cat?'Изменить категорию':'Добавить категорию'; $('#catName').value=cat?cat.name:''; $('#catDescription').value=cat?cat.description||'':''; $('#catWords').value=cat?cat.words.join('\n'):''; show('#formScreen'); }
